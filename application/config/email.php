...
$config['emailsmtphost']      = 'smtp.mailtrap.io:2525'; // Sets the SMTP host. You can also specify a different port than 25 by using
// this format: [hostname:port] (e.g. 'smtp1.example.com:2525').

$config['emailsmtpuser']      = '3759e956bf4230'; // SMTP authorisation username - only set this if your server requires authorization - if you set it you HAVE to set a password too
$config['emailsmtppassword']  = '5de1343ff53604'; // SMTP authorisation password - empty password is not allowed
